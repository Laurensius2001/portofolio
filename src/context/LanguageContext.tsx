...
const translations = {
  en: {
    ...
    hero: {
      ...
      description: 'Experienced in developing scalable web applications, handling both frontend and backend with a focus on clean architecture and performance.',
      button: 'More About Us'
    },
    about: {
      title: 'About Me',
      p1: "Hi, I'm Lorens — a Senior Full-Stack Web Developer. I specialize in building web-based systems and applications, handling end-to-end frontend and backend development.",
      p2: "I have experience in developing information systems, admin dashboards, and data-driven web applications. My focus is on creating scalable, efficient, and maintainable solutions that solve real-world problems."
    },
    services: {
      title: 'Services',
      items: [
    ...
    footer: {
      rights: '© 2026 LorensAdonara. Built with React & Vite.'
    }
  },
  id: {
    nav: {
    ...
    hero: {
      ...
      description: 'Berpengalaman dalam mengembangkan aplikasi web yang terukur, menangani frontend dan backend dengan fokus pada arsitektur yang bersih dan performa.',
      button: 'Lebih Lanjut'
    },
    about: {
      title: 'Tentang Saya',
      p1: "Hai, saya Lorens — seorang Senior Pengembang Web Full-Stack. Saya berspesialisasi dalam membangun sistem dan aplikasi berbasis web, dengan menangani pengembangan frontend dan backend secara menyeluruh.",
      p2: "Saya memiliki pengalaman dalam mengembangkan sistem informasi, dasbor admin, dan aplikasi web berbasis data. Fokus saya adalah menciptakan solusi yang terukur, efisien, dan mudah dipelihara untuk menyelesaikan masalah dunia nyata."
    },
    services: {
      title: 'Layanan',
      items: [
    ...
    footer: {
      rights: '© 2026 LorensAdonara. Dibuat dengan React & Vite.'
    }
  }
};
